module github.com/JulianVillingLS/pulumi-ionosdeveloper/provider
...
require (
	github.com/ionos-developer/terraform-provider-ionosdeveloper v0.0.1
...
require (
	...
	github.com/ionos-developer/dns-sdk-go v0.0.4 // indirect
