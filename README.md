...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `ionosdeveloper` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-ionosdeveloper
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-ionosdeveloper/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-ionosdeveloper/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-ionosdeveloper_darwin_amd64_v1
│   └── pulumi-resource-ionosdeveloper
├── pulumi-ionosdeveloper_darwin_arm64
│   └── pulumi-resource-ionosdeveloper
├── pulumi-ionosdeveloper_linux_amd64_v1
│   └── pulumi-resource-ionosdeveloper
├── pulumi-ionosdeveloper_linux_arm64
│   └── pulumi-resource-ionosdeveloper
├── pulumi-ionosdeveloper_windows_amd64_v1
│   └── pulumi-resource-ionosdeveloper.exe
└── pulumi-ionosdeveloper_windows_arm64
    └── pulumi-resource-ionosdeveloper.exe
```
